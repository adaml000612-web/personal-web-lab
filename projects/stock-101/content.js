...
const LESSONS = {
  ...
  price: {
    ...
    steps: [
      ...
      { type: 'complete', eyebrow: '本关完成', title: '你已经能更理性地看待价格变化', icon: '🌿', summary: ['成交价格来自当时买卖双方的报价。', '消息是否超出原有预期，可能比消息表面好坏更重要。', '不要用一个原因确定地解释市场涨跌。'], nextMessage: '第三关“股价不等于公司大小”现在已经可以开始。' }
    ]
  },
  'market-cap': {
    ...
    steps: [
      ...
      { type: 'complete', eyebrow: '本关完成', title: '你已经不会被单股价格迷惑', icon: '🌱', summary: ['市值等于股价乘以总股数。', '股价更高的公司，市值不一定更大。', '股价更低也不代表股票更便宜或更值得买。'], nextMessage: '第四关“收益与风险从哪里来”已经解锁，正式内容将在后续阶段加入。' }
    ]
  }
};
